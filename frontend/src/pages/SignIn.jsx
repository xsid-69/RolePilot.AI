  ...
  const testimonials = [
      {
          ...
          text: "I rehearse tough client conversations here before the real call.",
          avatarSrc: "https://randomuser.me/api/portraits/women/44.jpg"
      },
       {
          name: "Marcus Bell",
          handle: "Writer",
          text: "The personas keep their voice consistent across a whole scene.",
          ...
          >
            ...
            <div className="relative z-10">
              <motion.div variants={staggerItem} className="mb-8">
                ...
                <p className="text-gray-400 mt-2 text-sm font-medium">Sign in to pick up where you left off.</p>
              </motion.div>
            ...
            <motion.div variants={staggerItem} className="relative flex items-center justify-center my-2">
            ...
            <motion.div variants={staggerItem}>
              <motion.a
                ...
                whileTap={{ scale: 0.97 }}
                className="w-full flex items-center justify-center gap-3 border border-white/5 rounded-2xl py-3.5 bg-white/5 hover:bg-white/10 transition-colors cursor-pointer text-white shadow-lg"
              >
                  <GoogleIcon />
            ...
            <motion.p variants={staggerItem} className="text-center text-xs text-gray-500 font-medium mt-2">
