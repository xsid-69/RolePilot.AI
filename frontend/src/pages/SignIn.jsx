      ...
      <section className="flex-1 flex items-center justify-center p-4 md:p-8 relative z-10">
        <div className="w-full max-w-[440px] relative">
          ...
          <div className="flex flex-col gap-6 premium-card p-8 md:p-10 rounded-[2.5rem] shadow-2xl relative overflow-hidden border border-white/5 backdrop-blur-3xl">
            ...
            <a href={`${import.meta.env.VITE_API_URL}/api/auth/google`} className="animate-element animate-delay-800 w-full flex items-center justify-center gap-3 border border-white/5 rounded-2xl py-3.5 bg-white/5 hover:bg-white/10 transition-all duration-300 cursor-pointer active:scale-95 text-white shadow-lg">
                <GoogleIcon />
